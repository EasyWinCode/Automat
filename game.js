        ...
        */  
        checkWin: function() {
            ...
            for (var key in this.centerSymbols) {
			   ...
			   if((symbol == String(1))||(symbol == String(4))){
				   
				if((this.centerSymbols[key] !== String(1))&&(this.centerSymbols[key] !== String(4))){
				   isWin = false; 
				   //console.log('new');
				   //console.log(this.centerSymbols[key]);
                   break;
				}
			   }
               else if (symbol !== this.centerSymbols[key]) {
                   isWin = false; 
                   break;
			   }
